...
const Settings = ({ language, lightBox }) => {
   ...
   <li>
      ...
      <ul className="sidebar-sub-headers">
         ...
         <li className="sidebar-sub-header"><a href="#alistamiento" className="sidebar-link">Alistamiento</a></li>
   ...
   <li>
      ...
      <ul className="sidebar-sub-headers">
         <li className="sidebar-sub-header"><a href="#general" className="sidebar-link">General</a></li>
         <li className="sidebar-sub-header"><a href="#alistamiento" className="sidebar-link">enlistment</a></li>
...
<h2 id="alistamiento">Alistamiento</h2>
<p><em>En esta pantalla es posible gestionar las funcionalidades relacionadas al alistamiento de productos</em></p>
<p><img className="lightbox" src="/img/alistamiento/1.png"/></p>
...
<h2 id="alistamiento">Enlistment</h2>
<p><em>On this screen it is possible to manage the functionalities related to product enlistment</em></p>
<p><img className="lightbox" src="/img/alistamiento/1.png"/></p>
